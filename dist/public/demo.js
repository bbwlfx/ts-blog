...
/***/ "../node_modules/_@rematch_core@1.0.0-alpha.6@@rematch/core/dist/umd/rematch.js":
/*!**************************************************************************************!*\
  !*** ../node_modules/_@rematch_core@1.0.0-alpha.6@@rematch/core/dist/umd/rematch.js ***!
  \**************************************************************************************/
...
/* WEBPACK VAR INJECTION */(function(global, module) {(function (global, factory) {
	            ...
	            return function (payload, meta) { return __awaiter(_this, void 0, void 0, function () {
	                ...
	                return __generator(this, function (_a) {
	                    ...
	                    if (this.dispatch[modelName][reducerName].isEffect) {
	                        ...
	                        return [2 /*return*/, this.dispatch(action, this.storeGetState())];
	                    }
	...
	var effectsPlugin = {
	    ...
	    middleware: function (store) {
	        var _this = this;
	        return function (next) { return function (action, state) { return __awaiter(_this, void 0, void 0, function () {
	            return __generator(this, function (_a) {
	                switch (_a.label) {
	                    case 0:
	                    ...
	                    case 1:
	                        _a.sent();
	                        return [2 /*return*/, this.effects[action.type](action.payload, state, action.meta)];
	...
	exports.default = (function (_a) {
	    ...
	    _this.reducers = redux$$1.reducers;
	    // combine models to generate reducers
	    _this.mergeReducers = function (nextReducers) {
	    ...
	    _this.createModelReducer = function (model) {
	        ...
	        for (var _i = 0, _a = Object.keys(model.reducers || {}); _i < _a.length; _i++) {
	            ...
	            var action = isListener.default(modelReducer) ? modelReducer : model.name + "/" + modelReducer;
	    ...
	    _this.createRootReducer = function (rootReducers) {
	    ...
	    var rootReducer = _this.createRootReducer(redux$$1.rootReducers);
	...
	var Rematch = /** @class */ (function () {
	    function Rematch(config) {
	        var _this = this;
	        this.plugins = [];
	        this.pluginFactory = pluginFactory.default();
	        this.config = config;
	    ...
	    Rematch.prototype.init = function () {
	        ...
	        var redux = redux$1.default({
	            redux: this.config.redux,
	            models: this.models,
	        });
	        var rematchStore = __assign({}, redux.store, { 
	        ...
	        this.forEachPlugin('onStoreCreated', function (onStoreCreated) { return onStoreCreated(rematchStore); });
	...
	var isObject = function (obj) { return (Array.isArray(obj) || typeof obj !== 'object'); };
	/**
	 * mergeConfig
	 *
	...
	exports.dispatch = function (action) {
	    for (var _i = 0, _a = Object.keys(stores); _i < _a.length; _i++) {
	        var storeName = _a[_i];
	...
	exports.getState = function () {
	    ...
	    for (var _i = 0, _a = Object.keys(stores); _i < _a.length; _i++) {
	        var name_1 = _a[_i];
	        state[name_1] = stores[name_1].getState();
	    }
	    return state;
	};
	/**
	...
	exports.init = function (initConfig) {
	    ...
	    var store = new rematch.default(config).init();
	    stores[name] = store;
	    var _loop_1 = function (modelName) {
	        if (!exports.dispatch[modelName]) {
	            exports.dispatch[modelName] = {};
	        }
	        var _loop_2 = function (actionName) {
	            if (!isListener.default(actionName)) {
	                ...
	                exports.dispatch[modelName][actionName] = function (payload, meta) {
	                    for (var _i = 0, _a = Object.keys(dispatches[modelName][actionName]); _i < _a.length; _i++) {
	                        var storeName = _a[_i];
	        ...
	        for (var _i = 0, _a = Object.keys(store.dispatch[modelName]); _i < _a.length; _i++) {
	            var actionName = _a[_i];
	            _loop_2(actionName);
	        }
	    };
	    for (var _i = 0, _a = Object.keys(store.dispatch); _i < _a.length; _i++) {
	        var modelName = _a[_i];
	        _loop_1(modelName);
	    }
	    return store;
	...
	var lib_1 = lib.dispatch;
	var lib_2 = lib.getState;
	var lib_3 = lib.init;

	exports.default = index;
	exports.dispatch = lib_1;
	exports.getState = lib_2;
	exports.init = lib_3;
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../_webpack@4.16.2@webpack/buildin/global.js */ "../node_modules/_webpack@4.16.2@webpack/buildin/global.js"), __webpack_require__(/*! ./../../../../_webpack@4.16.2@webpack/buildin/module.js */ "../node_modules/_webpack@4.16.2@webpack/buildin/module.js")(module)))
...
/***/ "../node_modules/_react-dom@16.4.1@react-dom/cjs/react-dom.development.js":
/*!********************************************************************************!*\
  !*** ../node_modules/_react-dom@16.4.1@react-dom/cjs/react-dom.development.js ***!
  \********************************************************************************/
/*! no static exports found */
...
var React = __webpack_require__(/*! react */ "../node_modules/_react@16.4.1@react/index.js");
...
if (false) {} else {
  module.exports = __webpack_require__(/*! ./cjs/react-dom.development.js */ "../node_modules/_react-dom@16.4.1@react-dom/cjs/react-dom.development.js");
}


/***/ }),

/***/ "../node_modules/_react-loadable@5.4.0@react-loadable/lib/index.js":
/*!*************************************************************************!*\
  !*** ../node_modules/_react-loadable@5.4.0@react-loadable/lib/index.js ***!
  \*************************************************************************/
/*! no static exports found */
...
var React = __webpack_require__(/*! react */ "../node_modules/_react@16.4.1@react/index.js");
var PropTypes = __webpack_require__(/*! prop-types */ "../node_modules/_prop-types@15.6.2@prop-types/index.js");
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "../node_modules/_react@16.4.1@react/index.js");
...
/***/ "../node_modules/_react@16.4.1@react/cjs/react.development.js":
/*!********************************************************************!*\
  !*** ../node_modules/_react@16.4.1@react/cjs/react.development.js ***!
  \********************************************************************/
/*! no static exports found */
...
if (false) {} else {
  module.exports = __webpack_require__(/*! ./cjs/react.development.js */ "../node_modules/_react@16.4.1@react/cjs/react.development.js");
}
...
/* harmony import */ var lodash_es_isPlainObject__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash-es/isPlainObject */ "../node_modules/_lodash-es@4.17.10@lodash-es/isPlainObject.js");
...
/***/ "../node_modules/_regenerator-runtime@0.12.0@regenerator-runtime/runtime.js":
/*!**********************************************************************************!*\
  !*** ../node_modules/_regenerator-runtime@0.12.0@regenerator-runtime/runtime.js ***!
  \**********************************************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../_webpack@4.16.2@webpack/buildin/global.js */ "../node_modules/_webpack@4.16.2@webpack/buildin/global.js"), __webpack_require__(/*! ./../../_webpack@4.16.2@webpack/buildin/harmony-module.js */ "../node_modules/_webpack@4.16.2@webpack/buildin/harmony-module.js")(module)))
...
/***/ "../node_modules/_webpack@4.16.2@webpack/buildin/harmony-module.js":
/*!*************************************************************************!*\
  !*** ../node_modules/_webpack@4.16.2@webpack/buildin/harmony-module.js ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "../node_modules/_webpack@4.16.2@webpack/buildin/module.js":
/*!*****************************************************************!*\
  !*** ../node_modules/_webpack@4.16.2@webpack/buildin/module.js ***!
  \*****************************************************************/
/*! no static exports found */
...
var _reactDom = _interopRequireDefault(__webpack_require__(/*! react-dom */ "../node_modules/_react-dom@16.4.1@react-dom/index.js"));
...
var _core = __webpack_require__(/*! @rematch/core */ "../node_modules/_@rematch_core@1.0.0-alpha.6@@rematch/core/dist/umd/rematch.js");
...
function configure(initProps) {
  ...
  var _arr = Object.keys(models);

  for (var _i = 0; _i < _arr.length; _i++) {
    var model = _arr[_i];
    store.dispatch({
      type: "".concat(model, "/@init"),
...
var demo = {
  state: {},
  reducers: {
    '@init': function init(state, _init) {
      return _objectSpread({}, state, _init);
    },
...
var _demo = __webpack_require__(/*! ./demo */ "./js/models/demo.ts");
...
/***/ 0:
/*!*********************************************************!*\
  !*** multi regenerator-runtime/runtime ./js/entry/demo ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! regenerator-runtime/runtime */"../node_modules/_regenerator-runtime@0.12.0@regenerator-runtime/runtime.js");
module.exports = __webpack_require__(/*! ./js/entry/demo */"./js/entry/demo/index.tsx");
